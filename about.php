                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-0">
                                    <label class="control-label text-black text-small">Your name *</label>
                            ...
                            <div class="col-6">
                            <div class="form-group mb-0">
                            <label class="control-label text-black"> Phone *
                            </label>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    <label class="control-label text-black">Email address *</label>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="control-label text-black">Type Your Message *</label>
